...
export default class Login extends Component {
    ...
    onValidPassWord = () => {
        ...
        if(_pass_word != '' && _pass_word.length < 8){
            $('#error_pass_word').text('Độ dài tối thiểu 8 ký tự');
            return false;
        }
    ...
    onValidUserName = () => {
        ...
        if(_userName.length < 8 && _userName != ''){
            $('#error_user_name').text('Độ dài tối thiểu 8 ký tự');
            return false;
        }
        else{
    ...
    onLogin = (e) => {
        e.preventDefault();
        callApi('user/signup','POST',this.state.userInfo).then(res=>{
    ...
    onValidEmail = () => {
        ...
        if(!emailReg.test( _email )){
            $('#error_email').text('Định dạng email không đúng');
            return false;
        }
        else{
                    ...
                    <div className="col s6 offset-s3 login-component z-depth-2">
                        ...
                        <div className="col s12 login-btn">
                            ...
                            <div className="col s12 btn-div">
                                <button className="btn waves-effect waves-light" type="submit" id="btn-signin" disabled={!this.activeButton()} ><i className="material-icons">fingerprint</i>Sign In</button>
                            </div>
